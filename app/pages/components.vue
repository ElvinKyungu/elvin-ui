    ...
    <div class="flex flex-col w-full max-w-5xl 2xl:max-w-[80rem] mx-auto border-x border-zinc-800/60">
          ...
          <div class="p-4 flex flex-col gap-4">
            ...
            >
              <span
                ...
                :class="activeId === 'all' ? 'bg-accent shadow-[0_0_6px_rgba(99,102,241,0.6)]' : 'bg-zinc-700'"
              />
              <span class="flex-1 font-medium">All</span>
              <span class="text-[11px] tabular-nums px-1.5 py-0.5 rounded-md"
                :class="activeId === 'all' ? 'bg-zinc-700 text-zinc-300' : 'text-zinc-500'"
              >{{ totalCount }}</span>
            </button>
              ...
              <div v-for="cat in categories" :key="cat.id" class="flex flex-col">
                ...
                <div class="flex items-center">
                  ...
                  >
                    ...
                    <span class="text-[11px] tabular-nums px-1.5 py-0.5 rounded-md"
                      :class="activeId === cat.id ? 'bg-zinc-700 text-zinc-300' : 'text-zinc-500'"
                  ...
                  >
                    <svg
                      ...
                      :class="expandedCategories.has(cat.id) ? 'rotate-180' : 'rotate-0'"
                  ...
                  <div v-if="expandedCategories.has(cat.id)" class="flex flex-col gap-0.5 ml-4 pl-2 border-l border-zinc-800/60 my-0.5">
                    ...
                    >
                      <span
                        ...
                        :class="activeId === item.id ? 'bg-accent' : 'bg-zinc-700'"
                      />
      ...
      <main class="flex-1 min-w-0">
          ...
          >
            <div v-if="activeId !== 'all' || search" class="flex items-center gap-1.5 ml-1">
              <span v-if="activeId !== 'all'" class="flex items-center gap-1 text-xs px-2 py-0.5 bg-accent/15 text-accent border border-accent/20 rounded-full">
                ...
                <button @click="selectAll" class="hover:text-accent/70 transition-colors">
        ...
        <div v-if="!filteredItems.length" class="flex flex-col items-center justify-center h-64 gap-3 text-center px-6">
          ...
          <button @click="search = ''; selectAll()" class="text-xs text-accent hover:text-accent/70 transition-colors">
            Clear filters
          </button>
        </div>
