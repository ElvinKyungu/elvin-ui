      ...
      <main class="flex-1 min-w-0">
        ...
        <div class="sticky top-14 z-10 bg-zinc-950/90 backdrop-blur-md border-b border-zinc-800/60 h-11 flex items-center gap-3 px-4">
          ...
          >
            ...
            >
              <span v-if="activeCategory !== 'All'" class="flex items-center gap-1 text-xs px-2 py-0.5 bg-indigo-500/15 text-indigo-400 border border-indigo-500/20 rounded-full">
                {{ activeCategory }}
                <button @click="activeCategory = 'All'" class="hover:text-indigo-300 transition-colors">
