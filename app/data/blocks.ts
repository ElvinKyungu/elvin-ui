...
export const blockDocs: Record<string, BlockDoc> = {
  ...
  'contact-form': {
    ...
    name: 'Contact Form',
    category: 'Forms',
    description: 'Split-layout contact section with info panel and a validated form — name, email, subject, message. GSAP entrance and success state.',
    filename: 'ContactFormSection',
  ...
  login: {
    ...
    name: 'Login Card',
    category: 'Forms',
    description: 'Centered login card with Google/GitHub OAuth buttons, email + password fields, show/hide password toggle, remember me checkbox, and error shake animation.',
    filename: 'LoginCard',
    component: 'LoginCard',
    isNew: true,
  },
  signup: {
    ...
    name: 'Signup Card',
    category: 'Forms',
    description: 'Signup card with name, email, and password fields. Live password strength meter, terms checkbox, full validation, and animated success state.',
    filename: 'SignupCard',
  ...
  team: {
    ...
    name: 'Team Section',
    category: 'Content',
    description: 'Four-member team grid with gradient avatars, role, bio, online indicator, and social icon links. GSAP staggered scroll entrance.',
    filename: 'TeamSection',
  ...
  'pricing-toggle': {
    ...
    name: 'Pricing Toggle',
    category: 'Pricing',
    description: 'Three-tier pricing with monthly/annual toggle. GSAP price number flip on toggle, featured card highlight, and animated savings badge.',
    filename: 'PricingToggle',
