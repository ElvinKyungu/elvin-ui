...
<span class="text-[#e06c75]">&gt;</span><span class="text-[#f8f8f2]">
  ...
  Content here
        ...
        >
          ...
          <p class="text-xs text-zinc-600 font-mono uppercase tracking-wider mb-3">Variants</p>
          ...
          <p class="text-xs text-zinc-600 font-mono uppercase tracking-wider mb-3">Sizes</p>
        ...
        >
          ...
          <div class="mt-4 pt-4 border-t border-zinc-800">
            <p class="text-xs text-zinc-600 font-mono uppercase tracking-wider mb-3">In context</p>
            <div class="flex flex-wrap items-center gap-2">
      ...
      <div class="flex items-center gap-6 mb-12">
        ...
        <p class="text-xs text-zinc-600 font-mono uppercase tracking-widest shrink-0">Try it live</p>
        <div class="flex-1 h-px bg-zinc-800" />
      </div>
      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-8 space-y-8">
          ...
          <template v-if="activeTab === 'badges'">
            ...
            <div class="border-t border-zinc-800" />
            <div>
              <p class="text-xs text-zinc-600 mb-4 font-mono uppercase tracking-wider">With icons</p>
              <div class="flex flex-wrap items-center gap-2">
                <UiBadge variant="green">
                  <Icon name="lucide:check" class="w-3 h-3" />
                  SSR-safe
