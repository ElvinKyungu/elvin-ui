  ...
  <section ref="section" class="py-16 px-4">
    <div class="max-w-5xl mx-auto">
      ...
      <div class="flex items-center justify-center mb-8">
        <div
          class="flex items-center gap-1 bg-zinc-900 border border-zinc-800 rounded-xl p-1"
        >
          <button
            v-for="tab in tabs"
            :key="tab.id"
      ...
      <!-- Demo card -->
      <div
        class="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-8 space-y-8"
      >
        <!-- Buttons -->
        <template v-if="activeTab === 'buttons'">
          <div>
            <p
              class="text-xs text-zinc-600 mb-4 font-mono uppercase tracking-wider"
            >
              Variants
            </p>
